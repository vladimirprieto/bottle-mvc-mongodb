A simple boilerplate application structured following the MVC pattern using Bottle micro python framework.  is here to be used as my start skeleton future projects
